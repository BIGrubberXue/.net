...
<body>
    <form id="form1" runat="server" style="width:100%; margin: 10px auto">
        ...
        <div style="width:40%;display:inline-block;Float:left;height:475px">
            <asp:Image ID="Image1" runat="server" Height="448px" Width="448px"  ImageUrl="~/picture_keep/picture2.JPG" style="margin-left: 47px" />
=======
</head>
<body>
...
<<<<<<< HEAD
       <div style="height:auto">
            <table class="self-style3"><tr><td class="self-style1"><span class="self-style4">网站价格:</span></td>
                ...
                <tr><td class="self-style5"></td><td class="self-style2"><span class="self-style5">¥48</span></td></tr>
            </table>
